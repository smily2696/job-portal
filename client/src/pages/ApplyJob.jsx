...
const ApplyJob = () => {
  ...
  const [isAlreadyApplied, setIsAlreadyAppiled] = useState(false);
  ...
  const checkAlreadyApplied = () => {
    const hasAppiled = userApplications.some(
      (item) => item.jobId._id === jobsData._id
    );
    setIsAlreadyAppiled(hasAppiled);
  };
        ...
        <div className="bg-white text-black rounded-lg w-full">
          <div className="flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="text-center md:text-left text-neutral-700">
                ...
                <div className="flex flex-row flex-wrap gap-y-2 gap-6 items-center text-gray-600 mt-2">
                  ...
                  <span className="flex items-center gap-1">
                    <img src={assets.person_icon} alt="Level" /> {JobData.level}
                  </span>
                  <span className="flex items-center gap-1">
                    <img src={assets.money_icon} alt="Salary" /> CTC:{" "}
            ...
            <div className="flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center ">
              <button
                ...
                className="p-2.5 px-10 bg-blue-600 text-white rounded "
              >
                {isAlreadyApplied ? "Already Appiled" : "Apply Now"}
              </button>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start">
            <div className="w-full lg:w-2/3">
              ...
              <button
                onClick={applyHandler}
                className="p-2.5 px-10 bg-blue-600 text-white rounded mt-10"
              >
                {isAlreadyApplied ? "Already Appiled" : "Apply Now"}
              </button>
            </div>
